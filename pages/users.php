            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>";
                        echo "<a href='/pages/Includes/edit_user.php?id=" . $row["id"] . "' onclick='return confirmEdit();'> Edit</a> | ";
                        echo "<a href='/pages/Includes/delete_user.php?id=" . $row["id"] . "' onclick='return confirmDelete();'>Delete</a>";
                        echo "</td>";
                        echo "</tr>";
                    }
                } else {
